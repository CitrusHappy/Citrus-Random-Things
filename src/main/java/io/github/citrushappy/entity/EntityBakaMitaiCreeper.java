...
public class EntityBakaMitaiCreeper extends EntityMob {
    ...
    private int explosionRadius = 11;
    ...
    public void onUpdate()
    {
        if (this.isEntityAlive())
        {
            ...
            {
                this.playSound(SoundsHandler.ENTITY_BAKA_MITAI_CREEPER_FUSE, 1.0F, 1F);
            }
    ...
    public void onDeath(DamageSource cause)
    {
        ...
        if (this.world.getGameRules().getBoolean("doMobLoot"))
        {
            ...
            else if (cause.getTrueSource() instanceof EntityBakaMitaiCreeper && cause.getTrueSource() != this && ((EntityBakaMitaiCreeper)cause.getTrueSource()).getPowered() && ((EntityBakaMitaiCreeper)cause.getTrueSource()).ableToCauseSkullDrop())
            {
    ...
    private void explode()
    {
        if (!this.world.isRemote)
        {
            ...
            this.dead = true;
            this.world.playSound(null, getPosition(), SoundsHandler.ENTITY_BAKA_MITAI_CREEPER_BLOW, getSoundCategory(), 2.0F, 1.0F);
