...
public class RendererImposter extends GeoEntityRenderer<EntityImposter>
{
    private float rotationYaw;

    public RendererImposter(RenderManager renderManager)
    {
        super(renderManager, new ModelImposter());
    ...
    @Override
    protected void applyRotations(EntityImposter entityLiving, float ageInTicks, float rotationYaw, float partialTicks) {
     ...
     */
    @Override
    protected float getDeathMaxRotation(EntityImposter entity) {
        return 0f;
    }
